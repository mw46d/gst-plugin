...
# GST_PLUGIN_PATH=src gst-launch-1.0 v4l2src device=/dev/video0 ! 'image/jpeg,width=1920,height=1080,framerate=30/1' ! jpegdec ! videoconvert ! 'video/x-raw,format="RGB"' ! videoconvert ! fpsdisplaysink
